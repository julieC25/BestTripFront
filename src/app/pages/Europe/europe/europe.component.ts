...
export class EuropeComponent implements OnInit {
  ...
  isPaysInEurope(p:Pays){
    return p.nomContinent == 'europe';
  }
  isLieuInEurope(l:Lieu){
    return l.ville.pays.nomContinent == 'europe'
  }
  isVilleInEurope(v:Ville){
    return v.pays.nomContinent == 'europe';
  }
  saveContinent(){
    this.paysgenerique.pays = new Pays();
    this.paysgenerique.ville = new Ville();
    this.paysgenerique.lieu = new Lieu();
    this.paysgenerique.pays.nomContinent = 'europe';
